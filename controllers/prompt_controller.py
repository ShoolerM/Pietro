...
class PromptController:
    ...
    def add_supplemental(self):
        ...
        filename, ok = self.view.show_input_dialog(
            "New Supplemental Prompt", "Enter filename (e.g., my_prompt.txt):"
        )
    ...
    def add_system_prompt(self):
        ...
        filename, ok = self.view.show_input_dialog(
            "New System Prompt", "Enter filename (e.g., my_system_prompt.txt):"
        )
    ...
    def save_file(self, file_path: Path, content):
