...
class SummaryModel(Observable):
    ...
    def update_rolling_summary(self, summary: str, tokens: int):
        ...
        self.notify_observers('rolling_summary_updated', {
            'summary': summary,
            'tokens': tokens
        })
    ...
    def get_context_for_llm(self, raw_recent_text: str, raw_recent_tokens: int) -> tuple[str, int]:
        ...
        if self._rolling_summary:
            context_parts.append(f"STORY SUMMARY (prior events):\n{self._rolling_summary}")
    ...
    def load_from_file(self, filepath: str) -> bool:
        ...
        try:
            ...
            self._max_rolling_summary_tokens = data.get('max_rolling_summary_tokens', 1000)
