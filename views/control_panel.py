...
class ControlPanel(QtWidgets.QWidget):
    ...
    def _init_ui(self):
        ...
        self.input_field.setPlaceholderText('Type your main query here. Enter to send, Shift+Enter for newline')
        ...
        self.context_limit_spinbox.setToolTip('Maximum context size. Story will be auto-summarized if it exceeds this limit.')
        self.context_limit_spinbox.valueChanged.connect(lambda val: self.context_limit_changed.emit(val))
    ...
    def _on_send(self):
        ...
        self.send_clicked.emit("", "", "", "")  # Empty strings - main_view will fill these
